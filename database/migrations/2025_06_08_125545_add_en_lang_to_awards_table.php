...
return new class extends Migration
{
    public function up()
    {
        DB::statement('ALTER TABLE awards ALTER COLUMN title TYPE json USING title::json;');
        DB::statement('ALTER TABLE awards ALTER COLUMN content TYPE json USING content::json;');
